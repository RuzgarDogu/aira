...
# total_steps = 10000
# description = "Testing Success Rate With ${} Commission Fee ...".format(config.transaction_fee)
...
# print("Success rate with ${} fee: {}%".format(config.transaction_fee, (success / (success + fail)) * 100))
